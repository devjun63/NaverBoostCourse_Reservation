                ...
                <li class="item" style="width: 414px">
                  ...
                  <div class="preview_txt">
                    ...
                    ><em class="preview_txt_dsc"
                      >2017.2.17.(금)~2017.4.18.(화), 잔여티켓 2769매</em
                    >
                  </div>
                </li>
              </ul>
            ...
            <div class="ticket_body">
              ...
              <div class="qty">
                <div class="count_control">
                  <div class="clearfix">
                    <a
                      href="#"
                      class="btn_plus_minus spr_book2 ico_minus3"
                      title="빼기"
                    >
                    </a>
                    <input
                      type="tel"
                      class="count_control_input"
                      value="10"
                      readonly
                      title="수량"
                    />
                  ...
                  <div class="individual_price on_color">
                    <span class="total_price">68,000</span
                    ><span class="price_type">원</span>
                  </div>
                </div>
                <div class="qty_info_icon">
                  <strong class="product_amount"> <span>유아</span> </strong>
                  <strong class="product_price">
              ...
              <div class="qty">
                <div class="count_control">
                  ...
                  <div class="individual_price on_color">
                    <span class="total_price">60,000</span
                    ><span class="price_type">원</span>
                  </div>
                </div>
                <div class="qty_info_icon">
                  <strong class="product_amount"> <span>세트1</span> </strong>
                  <strong class="product_price">
              ...
              <div class="qty">
                <div class="count_control">
                  ...
                  <div class="individual_price on_color">
                    <span class="total_price">25,500</span
                    ><span class="price_type">원</span>
                  </div>
                </div>
                <div class="qty_info_icon">
            ...
            <div class="section_booking_agreement">
              ...
              <div class="agreement">
                ...
                <div class="useragreement_details">
                  ...
                  기록보존, 네이버 예약 이용 후 리뷰작성에 따른 네이버페이
                  포인트 지급 및 관련 안내<br /><br />
                  3. 보관기간<br />
              ...
              <div class="agreement">
                ...
                <div class="useragreement_details custom_details_wrap">
                  <div class="custom_details">
                    ...
                    2. 제공하는 개인정보 항목 : [필수] 네이버 아이디, 이름,
                    연락처 [선택] 이메일 주소<br /><br />
                    3. 개인정보를 제공받는 자의 이용목적 : 사업자회원과
                    예약이용자의 원활한 거래 진행, 고객상담, 불만처리 등 민원
                    처리, 서비스 이용에 따른 설문조사 및 혜택 제공, 분쟁조정
                    해결을 위한 기록보존<br /><br />
                    4. 개인정보를 제공받는 자의 개인정보 보유 및 이용기간 :
                    개인정보 이용목적 달성 시 까지 보관합니다.<br /><br />
