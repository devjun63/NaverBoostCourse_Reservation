...
public class getProductsTest {
	...
	public static void main(String[] args) {
		...
		ReservationService reservationServiceTest = ac.getBean(ReservationService.class);
		...
		reservationInfoResponse = reservationServiceTest.getReservationInfo("kimjinsu@connect.co.kr");
		
		for(int i = 0; i < reservationInfoResponse.getSize(); i++)
		{
			System.out.println(reservationInfoResponse.getReservations());
		}
